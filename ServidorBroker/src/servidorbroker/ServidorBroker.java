 ...
 * @author daniel
 */
public class ServidorBroker extends JFrame implements ActionListener {
    ...
    public static void main(String[] args) {
        ServidorBroker panel = new ServidorBroker();
